...
export default function TriggerAddQuest(props) {
    return (
        ...
        <div className="w-2/3">
          ...
          <div className="answerscontainer mt-6 ml-6">
            <p className="font-sans font-bold text-base text-gray-600">USERNAME :</p>
            <input className="font-sans  ml-2 mt-1  text-gray-600 "/>
          </div>
          <div className="answerscontainer mt-6 ml-6">
            <p className="font-sans font-bold text-base text-gray-600">ADD QUESTION :</p>
            <input className="font-sans  ml-2 mt-1  text-gray-600 "/>
          </div>
        </div>
